            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST">
                    ...
                    <div class="container-login100-form-btn">
                        <input class="login100-form-btn" type="submit" name="registration" value="Зарегистрироваться">
                    </div>
...
if (isset($_POST['registration'])) {
    ...
    $query = mysqli_query($DataBaseHandle, "SELECT id_person FROM person WHERE `email`='".mysqli_real_escape_string($DataBaseHandle, $_POST['email'])."'");
    ...
    if(count($err) == 0)
    {
        mysqli_query($DataBaseHandle,"INSERT INTO `person`( `email`, `password`) VALUES ('$login', '$password')");
    }
    else
    {
        ?><script type="text/javascript">
						$(document).ready(function() {
							demo.showNotificationerrorautorization();
						});
					</script><?
